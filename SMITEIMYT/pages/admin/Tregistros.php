        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            Base de datos con todos los registros de usuarios.
                        </div>
                    </div>
                    <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row['no_transferencia']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['fecha_transferencia']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['archivo']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['tipo_inscripcion']; ?>
                                        </td>
                                        <td>
